...
import '../../views/subcategory_shop/subcategories_controller.dart';
import '../../views/subcategory_shop/subcategories_model.dart';
import '../../views/wallet_shop/wallet_by_shop_controller.dart';
...
borderRadius: BorderRadius.circular(15)
                    ...
                    child: Row(
                      children: [
                             InkWell(child: const Icon(Icons.add,color: AppColors.primaryColor),
                     onTap: () {
                     ...
                     setState(() {
                       ...
                       log('lll');
                     //  subCategoriesController.updateCounter(widget.model.id,widget.model.counter);
                       subCategoriesController.getTotalPriceInCart2();
                       log( subCategoriesController.getTotalPriceInCart2().toString());
                     });
                     ...
                     Text('${widget.model.counter}'),
                        const SizedBox(width: 9,),
                        InkWell(child: const Icon(Icons.remove,color: AppColors.primaryColor),
                          onTap: () {
                            subCategoriesController.updateCounter(widget.model.id,widget.model.counter);
                            subCategoriesController.getTotalPriceInCart2();
                            print(     subCategoriesController.getTotalPriceInCart2());
                            setState(() {
