...
import 'package:userwasil/services/Network.dart';
import 'package:userwasil/utils/helper/InternetUtils.dart';
import 'package:http/http.dart' as http;
import 'package:userwasil/config/custom_package.dart';
import 'package:userwasil/model/address.dart';
...
class AddressController extends GetxController {
  ...
  get listDefaultAddress =>
      listAddress.value.where((element) => element.isDefault).toSet().toList();
