...
ThemeData themeEnglish = ThemeData(
  ...
  textTheme: const TextTheme(
      headline1: TextStyle(
          fontWeight: FontWeight.bold, fontSize: 22, color: AppColors.secondaryColor),
      headline2: TextStyle(
          fontWeight: FontWeight.bold, fontSize: 26, color:  AppColors.secondaryColor),
      bodyText1: TextStyle(
          height: 2,
          color:  AppColors.secondaryColor,
          fontWeight: FontWeight.bold,
          fontSize: 14),
      bodyText2: TextStyle(height: 2, color: AppColors.secondaryColor, fontSize: 14)),
...
ThemeData themeArabic = ThemeData(
  ...
  textTheme: const TextTheme(
      ...
      bodyText1: TextStyle(
          ...
          fontWeight: FontWeight.bold,
          fontSize: 14),
      bodyText2: TextStyle(height: 2, color:AppColors.borderColor, fontSize: 14)),
  primarySwatch: Colors.blue,
);
/*
* File : App Theme
