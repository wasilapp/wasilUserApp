      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
              ...
              child: Row(
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      Text(
                          '${controller.myOrders!.type == 0 ? "Home" : "Work"} '
                          '(${controller.myOrders!.address!.name.toString()}) ',
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          Text(
                              ': ${controller.myOrders!.orderPayment!.paymentType == 2 ? 'Cash' : 'wallet'}',
                              style: const TextStyle(
                                  fontSize: 14,
                                  fontWeight: FontWeight.w400,
                                  color: Color(0xffA6A6A6))),
            ...
            ListView.builder(
              itemBuilder: (context, index) {
                return ListTile(
                  ...
                  title: Text(controllerLocale.language!.languageCode == 'en'
                      ? '${controller.myOrders!.carts![index].subCategory!.title!.en}'
                    ...
                    children: [
                      Row(
                        children: [
                          Text("amount".tr),
                          Text(
                              ': ${controller.myOrders!.carts![index].subCategory!.quantity!}${controllerLocale.language!.languageCode == 'en' ? '${controller.myOrders!.carts![index].subCategory!.quantity!}' : '${controller.myOrders!.carts![index].subCategory!.title!.ar}'}'),
                        ],
                      ),
                      Row(
                        children: [
                          Text("price".tr),
                          Text(
                              ': ${controller.myOrders!.carts![index].subCategory!.price!}'),
                        ],
                      ),
                    ],
                  ),
              ...
              shrinkWrap: true,
              itemCount: controller.myOrders!.carts!.length,
            ),
            Container(
                width: 390,
                height: 5,
            ...
            const Spacer(),
            controller.myOrders!.status == 1
                ? InkWell(
                    onTap: () {
                      controller.cancelOrder(controller.myOrders!.id!.toInt());
                      controller
                          .getDetailOrders(controller.myOrders!.id!.toInt());
                    },
                    child: Container(
                      ...
                      child: const Center(child: Text('Cancel Order')),
                    ),
                  )
                : const Text('')
          ],
