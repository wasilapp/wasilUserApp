...
import 'package:google_maps_flutter/google_maps_flutter.dart';
import 'package:intl/intl.dart';
import 'package:userwasil/views/nearset_order_main_subcategory/main_sub_controller.dart';
...
import '../subcategory_shop/subcategories_model.dart';

class CheckoutScreenDriver extends StatefulWidget {
  const CheckoutScreenDriver({super.key});
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      //           orderController.createOrder(
                      //               categoryId: 1,
                      //               paymentType: selectedPayment == 'Cash'.tr ? 2 : 1,
                      //
                      //               walletId: 1,
                      //               //todo get wallet id
                      //               //    "order_type": "scheduled",
