...
class wid extends StatelessWidget {
                  ...
                  Container(margin: EdgeInsets.symmetric(horizontal: 20),
                    ...
                    child: Column(mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        ...
                        InkWell(
                          onTap:  _isInCart?(){
      controller.removeOneItem(model.id as String);}
        : () {
    // if (_isInCart) {
    //   return;
    // }
  ...
  orderId: 1,
    total: 2,price: 2,subCategoriesId: model.id,id: model.id!.toInt(),
    quantity: int.parse('2'));
    print(_isInCart);
    },
                            child: Text(_isInCart ? 'In cart' : 'Add to cart',style: TextStyle(color: Colors.black,fontSize: 20,fontWeight: FontWeight.w500),))
                , SizedBox(height: 10,),
                      ],
                    ),
                  ),
