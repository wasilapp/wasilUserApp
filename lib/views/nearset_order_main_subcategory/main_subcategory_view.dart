...
const SizedBox(height: 10,),
          Container(child:    const AddressWidget(),
          ...
          Obx(() {
            ...
            return Center(
              child: Container(height: 200,
                child: ListView.builder(scrollDirection: Axis.horizontal,physics: const NeverScrollableScrollPhysics(),
                  itemBuilder: (context, index) {
                    return wid( model: controller.mainSubcategoryList[index],);
                  },
        ...
        id==null? const Text(''): Padding(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start,
             ...
             Padding(
                  ...
                  child: Material(color: Colors.white,elevation: 10,
                    borderRadius: BorderRadius.circular(10),
                    child: DropdownButton<String>(dropdownColor: Colors.white,underline: Text(''),isExpanded: true,borderRadius: BorderRadius.circular(10),
                      elevation: 10,hint: const Text('select price'  ,                  style: TextStyle(fontWeight: FontWeight.w100,color: Colors.black)),
padding: const EdgeInsets.symmetric(horizontal: 10),

                      value:    id==1?  selectedPriceRange:selectedPriceNewRange,
                      onChanged: ( newValue) {
                        setState(() {
                          id==1?  selectedPriceRange:selectedPriceNewRange = newValue;
                        });
                      },
                       items:    id==1?   priceRanges.map((String priceItem) {
                        return DropdownMenuItem<String>(
                          value: priceItem,
                          child: Text(priceItem),
                        );
                      }).toList(): priceNewRanges.map((String priceItem) {
                         return DropdownMenuItem<String>(
                           value: priceItem,
                           child: Text(priceItem),
                         );
          ...
          Spacer(),
CommonViews().createButton(title: 'Check out', onPressed: () {
   ...
   children: [
     Padding(
       ...
       child: InkWell(
         ...
         child: Material(elevation: 10,color: Colors.white,
           borderRadius: BorderRadius.circular(10),
                 ...
                 decoration: const BoxDecoration(
                  ...
                  // border: Border.all(color: AppColors.primaryColor),borderRadius: BorderRadius.circular(10)
                    ...
                    child: Column(mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Image.network('https://news.wasiljo.com/${model.imageUrl}',height: 100,
                        ),
               Text(model.title!.en!.toString()),
                        Text('Add Item',style: TextStyle(color: Colors.black,fontWeight: FontWeight.w500),)
                      ],
                    ),
                  ),
