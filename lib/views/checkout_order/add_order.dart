...
AuthController controller=Get.put(AuthController());
  ...
  var addOrder =   Uri.parse('https://news.wasiljo.com/public/api/v1/user/orders'); // Replace with your actual URL
var token=await controller.getApiToken();
    ...
    //   "order": order,
    //   "delivery_boy_id":delivery_boy_id==null?null:delivery_boy_id,
...
print(response.body);
      if (response.statusCode == 200) {
        ...
        Get.snackbar(' Failed to create the order ', '${json.decode(response.body)['error']}',
