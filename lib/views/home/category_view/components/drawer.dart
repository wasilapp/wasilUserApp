...
class _DrawerWidgetState extends State<DrawerWidget> {
  ...
  late CustomAppTheme customAppTheme;    String language='en';
  @override
               ...
               GestureDetector(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          ...
                          Text(email!,style: whitebasic,),
                        ],
                      ),
                    ),

  Divider(height: 1.h,thickness: 1.2,color: Colors.white,),
                    SizedBox(height: 1.h,),
                    ListTile(
                      title: Row(
                        children: [
                          Icon(Icons.home_filled,color: AppColors.backgroundColor,),
                          SizedBox(width: 10,),
                          Text(Translator.translate("orders".tr),style: whitebasic,),
                        ],
                      ),
                      onTap: () {
                        UserNavigator.of(context).push( AllOrder());
                    ...
                    ListTile(
                      title: Row(
                        children: [
                          Icon(Icons.person_2_outlined,color: AppColors.backgroundColor,),
                          SizedBox(width: 1.w,),
                          Text(Translator.translate("edit profile".tr),style: whitebasic,),
                        ],
                      ),
                      onTap: () {
                    ...
                    ListTile(
                      title: Row(
                        children: [
                          ...
                          SizedBox(width: 10,),
                          Text(Translator.translate("coupon book".tr),style: whitebasic,),
                        ],
                      ),
                      onTap: () {
                        UserNavigator.of(context).push( WalletScreen());
                   ...
                   //  ),
                    ...
                    ListTile(
                      title: Row(
                        children: [
                          const Icon(Icons.language,color: AppColors.backgroundColor,),
                          const SizedBox(width: 10,),
                          Text(Translator.translate("select_language".tr),style: const TextStyle(
                            fontSize: 16,
...
// );
                    ...
                    ListTile(
                      title: Row(
                        children: [
                          Icon(Icons.call,color: AppColors.backgroundColor,),
                          SizedBox(width: 10,),
                          Text(Translator.translate("contact_us".tr),style: whitebasic,),
                        ],
                      ),
                      onTap: () {
                    ...
                    ListTile(
                      title: Row(
                        children: [
                          Icon(Icons.share,color: AppColors.backgroundColor,),
                          SizedBox(width: 10,),
                          Text(Translator.translate("share".tr),style: whitebasic,),
                        ],
                      ),
                      onTap: () async {
                        print('kk');
       ...
       ListTile(
              title: Row(
                children: [
                  ...
                  const SizedBox(width: 10,),
                  Text(Translator.translate("delete_account".tr),style: whitebasic,),
                ],
              ),
              onTap: () async {
          ...
          Divider(height: 23,thickness: 1.2,),
            ListTile(
              title: Row(
                children: [
                  Icon(Icons.logout,color: AppColors.backgroundColor,),
                  SizedBox(width: 10,),
                  Text(Translator.translate("logout".tr),style: whitebasic,),
                ],
              ),
              onTap: () async {
