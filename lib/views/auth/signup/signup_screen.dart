            ...
            children: <Widget>[
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border:
                      Border.all(color: const Color(0xffdcdee3), width: 1.5),
                ),
              ...
              // 'https://admin.wasiljo.com/public/api/v1/user/register?lang=${controller.language}',
              // data: {
              ...
              signUpController.errorList.length == 0
                  ? Text('')
                  : Obx(() => Container(
