...
class ShopsController extends GetxController {
  ...
  void fetchShops() async {
    ...
    final response = await http.get(
        Uri.parse(
          'https://admin.wasiljo.com/public/api/v1/user/get-delivery-or-shop-by-location/1/location?latitude=37.4235492&longitude=122.0924447lang=${controller.language}',
        ),
        headers: headers);
    ...
    if ((response.statusCode >= 200 && response.statusCode < 300)) {
      ...
      if (json.decode(response.body)['data']['shops'].isEmpty) {
        print(
            'response.isEmpty  id${json.decode(response.body)['data']['shops']}');
